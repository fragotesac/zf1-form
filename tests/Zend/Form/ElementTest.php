...
class Zend_Form_ElementTest extends PHPUnit\Framework\TestCase
{
    ...
    public function testIsValidInsertsNotEmptyValidatorWhenElementIsRequiredByDefault()
    {
        ...
        $this->assertInstanceOf(Zend_Validate_NotEmpty::class, $validator);
    ...
    public function testCanAddAllPluginLoaderPrefixPathsSimultaneously()
    {
        ...
        $this->assertIsArray($paths, var_export($paths, 1));
        $this->assertStringContainsString('Decorator', $paths[0]);
    }
    ...
    public function testCanAddSingleValidatorAsString()
    {
        ...
        $this->assertInstanceOf(Zend_Validate_Digits::class, $validator, var_export($validator, 1));
    ...
    public function testOptionsAreCastToArrayWhenAddingValidator()
    {
        ...
        $this->assertInstanceOf(Zend_Validate_Alnum::class, $validator);
    ...
    public function testCanAddMultipleValidators()
    {
        ...
        $this->assertInstanceOf(Zend_Validate_Digits::class, $digits);
        $alnum = $this->element->getValidator('alnum');
        $this->assertInstanceOf(Zend_Validate_Alnum::class, $alnum);
    }
    ...
    public function testCanAddSingleFilterAsString()
    {
        ...
        $this->assertInstanceOf(Zend_Filter_Digits::class, $filter);
    }
    ...
    public function testShouldUseFilterConstructorOptionsAsPassedToAddFilter()
    {
        ...
        $this->assertInstanceOf(Zend_Filter_HtmlEntities::class, $filter);
    ...
    public function testCanAddMultipleFilters()
    {
        ...
        $this->assertInstanceOf(Zend_Filter_Digits::class, $digits);
        $alnum = $this->element->getFilter('alnum');
        $this->assertInstanceOf(Zend_Filter_Alnum::class, $alnum);
    }
    ...
    public function testSetOptionsSetsArrayOfStringValidators()
    {
        ...
        $this->assertInstanceOf(Zend_Validate_NotEmpty::class, $validator);
        $validator = $this->element->getValidator('digits');
        $this->assertInstanceOf(Zend_Validate_Digits::class, $validator);
    }
    ...
    public function testSetOptionsSetsArrayOfStringFilters()
    {
        ...
        $this->assertInstanceOf(Zend_Filter_StringToUpper::class, $filter);
    ...
    public function testSetOptionsSetsGlobalPrefixPaths()
    {
        ...
        foreach (array('validate', 'filter', 'decorator') as $type) {
            ...
            $this->assertIsArray($paths, "Failed for type $type: " . var_export($paths, 1));
